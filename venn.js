const data = { 
    ...
    { top: 45, left: 40, content: 'electronic_digital_materials.md', title: 'Electronic Digital Materials & Assemblers', image: 'content/stapler/images/assembler_gantry02.jpg' },
    { top: 65, left: 45, content: 'makerbot.md', title: 'Makerbot Industries', image: 'content/makerbot/globe_small_1.png' },
    { top: 25, left: 30, content: 'assorted_projects.md', title: 'Assorted Projects', image: 'content/ocelot/images/ocelot1.jpeg' },
    { top: 30, left: 25, content: 'machine_building.md', title: 'Machine Building', image: 'content/dwedm2_01.jpeg' },
    ...
    { top: 55, left: 50, content: 'papers_and_patents.md', title: 'Papers and Patents', image: 'content/patent.png' }, 
]}
